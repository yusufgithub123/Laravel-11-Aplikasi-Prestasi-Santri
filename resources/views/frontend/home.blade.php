...
<section id="hero" class="px-0">
    <div class="container text-center text-white">
        <div class="hero-title" data-aos="fade-up">
            <div class="hero-text" style="font-size: 3.5rem; font-weight: bold; text-shadow: 2px 2px 4px rgba(0, 0, 0, 0.500);">
                Pondok Pesantren<br> Darul Hijrah
            </div>
            <h4 style="text-shadow: 4px 4px 3px rgba(0, 0, 0, 0.500);">
                Sistem Pendukung Keputusan Beasiswa Santri
            </h4>
        </div>
    </div>
</section>
