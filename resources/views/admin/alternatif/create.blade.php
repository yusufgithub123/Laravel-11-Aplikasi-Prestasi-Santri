            ...
            <form action="{{ route('alternatif.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        <div>
                            ...
                            <input class="form-control @error('nama_santri') is-invalid @enderror" id="nama_santri" type="text" placeholder="Nama" name="nama_santri" required value="{{ old('nama_santri') }}">
                        </div>
                        @error('nama_santri')
                    ...
                    <div class="col-md-6 mb-3">
                        <div>
                            ...
                            <input class="form-control @error('nisn') is-invalid @enderror" id="nisn" type="text" placeholder="NISN" name="nisn" required value="{{ old('nisn') }}">
                        </div>
                        @error('nisn')
                            <div class="alert alert-danger mt-2">
                                {{ $message }}
                ...
                <div class="row align-items-center">
                    <div class="col-md-6 mb-3">
                        ...
                        <input class="form-control @error('alamat') is-invalid @enderror" id="alamat" type="text" placeholder="Alamat"  name="alamat" required value="{{ old('alamat') }}">
                    </div>
                    @error('alamat')
                            <div class="alert alert-danger mt-2">
                                {{ $message }}
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        <div class="form-group">
                            ...
                            <input class="form-control @error('nama_ayah') is-invalid @enderror" id="nama_ayah" type="text" placeholder="Nama Ayah" name="nama_ayah" required value="{{ old('nama_ayah') }}">
                        </div>
                        @error('nama_ayah')
                            <div class="alert alert-danger mt-2">
                                {{ $message }}
                    ...
                    <div class="col-md-6 mb-3">
                        <div class="form-group">
                            ...
                            <input class="form-control @error('nama_ibu') is-invalid @enderror" id="nama_ibu" type="text" placeholder="Nama Ibu" name="nama_ibu" required value="{{ old('nama_ibu') }}">
                        </div>
                        @error('nama_ibu')
                            <div class="alert alert-danger mt-2">
                                {{ $message }}
                    ...
                    <div class="card card-body border-0 shadow mb-4">
                        <h2 class="h5 mb-4">Pilih Gambar</h2>
                            <div class="d-flex align-items-center">
                                <!-- <div class="me-3">
                                    // Avatar
                                    <img class="rounded avatar-xl" src="" alt="change avatar">
                                </div> -->
